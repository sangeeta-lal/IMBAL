...
public class TOMCAT_Training5_CATCH
{
	...
	//@Note: create this file using create_file_listing.py
	 ...
	 String non_logged_file_path = "F:\\Research\\L5IMBAL\\result\\tomcat_non_log_catch.txt";
	 String logged_file_path = "F:\\Research\\L5IMBAL\\result\\tomcat_log_catch.txt";
	 String table = "tomcat_catch_training5";
	//*/
	...
	//@Note: create this file using create_file_listing.py
	 String listing_file_path = "E:\\Sangeeta\\Research\\L5IMBAL\\result\\tomcat-8.0.9_java_files.txt";  
	 String non_logged_file_path = "E:\\Sangeeta\\Research\\L5IMBAL\\result\\tomcat_non_log_catch.txt";
	 String logged_file_path = "E:\\Sangeeta\\Research\\L5IMBAL\\result\\tomcat_log_catch.txt";
	  String table = "tomcat_catch_training5";
   //*/
	...
	//@Note: create this file using create_file_listing.py
	 ...
	 String non_logged_file_path = "D:\\Sangeeta\\Research\\L5IMBAL\\result\\tomcat_non_log_catch.txt";
	 String logged_file_path = "D:\\Sangeeta\\Research\\L5IMBAL\\result\\tomcat_log_catch.txt";
	  String table = "tomcat_catch_training5";
  //*/
	...
	public static void main(String[] args) 
	{
		...
		TOMCAT_Training5_CATCH demo = new TOMCAT_Training5_CATCH();
...
public void ast_prser(String file_name)
	{
		try
		{
			...
			rawContent = TOMCAT_Training5_CATCH.readFileToString(file_name);
