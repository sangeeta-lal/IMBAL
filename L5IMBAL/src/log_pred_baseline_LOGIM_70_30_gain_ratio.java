 ...
 * */
public class log_pred_baseline_LOGIM_70_30_gain_ratio
{
...
//Mjority Vote
public Evaluation pred2_gain_ratio_maj_vote( int itr, int p_of_features) 
{
...
// Average Vote
public Evaluation pred2_gain_ratio_avg_vote( int itr, int p_of_features) 
{
...
//max Vote
public Evaluation pred2_gain_ratio_max_vote( int itr, int p_of_features) 
{
...
//Stacking Vote
public Evaluation pred2_gain_ratio_stack( int itr, int p_of_features) 
{
...
//Bagging Vote
public Evaluation pred2_gain_ratio_bagging( int itr, int p_of_features, Classifier  classif) 
{
...
//Boosting Vote
public Evaluation pred2_gain_ratio_boosting( int itr, int p_of_features, Classifier  classif) 
{
...
public static void main(String args[])
	{
		...
		log_pred_baseline_LOGIM_70_30_gain_ratio clp = new log_pred_baseline_LOGIM_70_30_gain_ratio();
		String classifier_name= "";
		String ensemble_tech = "";
		String feature_selection_tech= "gain-ratio";
				...
				for(int i=0; i<clp.iterations; i++)
					{
				    	...
				    	clp.pre_process_data();
					     ...
					     clp.result = clp.pred2_gain_ratio_maj_vote(i, p_of_features);	
				    
					     classifier_name = "J48-RF-SVM";
				    	 ensemble_tech= "Average Vote";
					     clp.result = clp.pred2_gain_ratio_avg_vote(i, p_of_features);	
				    
				    	  classifier_name = "J48-RF-SVM";
				    	  ensemble_tech= "Max Vote";
					      clp.result = clp.pred2_gain_ratio_max_vote(i, p_of_features);	
				    
				    	   classifier_name = "J48-RF-SVM";
				    	   ensemble_tech= "Stacking";
					       clp.result = clp.pred2_gain_ratio_stack(i, p_of_features);	
				   
					     
				    	  classifier_name = "J48";
				    	  ensemble_tech= "Bagging";
					      clp.result = clp.pred2_gain_ratio_bagging(i, p_of_features, new J48());	
					      
					      classifier_name = "RF";
				    	  ensemble_tech= "Bagging";
					      clp.result = clp.pred2_gain_ratio_bagging(i, p_of_features, new RandomForest());	
					     
					      classifier_name = "SMO";
				    	  ensemble_tech= "Bagging";
					      clp.result = clp.pred2_gain_ratio_bagging(i, p_of_features, new SMO());	
					    
					      classifier_name = "J48";
				    	  ensemble_tech= "BoosTing";
					      clp.result = clp.pred2_gain_ratio_boosting(i, p_of_features, new J48());	
					    
					      classifier_name = "RF";
				    	  ensemble_tech= "Boosting";
					      clp.result = clp.pred2_gain_ratio_boosting(i, p_of_features, new RandomForest());	
					     
					      classifier_name = "SMO";
				    	  ensemble_tech= "Boosting";
					      clp.result = clp.pred2_gain_ratio_boosting(i, p_of_features, new SMO());	 
