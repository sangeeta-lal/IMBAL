...
public class Hadoop_Training5_IF
{
	...
	String table ="hd_if_training5";	
    String listing_file_path = "F:\\Research\\L5IMBAL\\result\\hd_java_files.txt";
    
    String non_logged_file_path = "F:\\Research\\L5IMBAL\\result\\hd_non_log_if.txt";
	String logged_file_path = "F:\\Research\\L5IMBAL\\result\\hd_log_if.txt";
	...
	String table ="hd_if_training5";
    String listing_file_path = "E:\\Sangeeta\\Research\\L5IMBAL\\result\\hd_java_files.txt"; 
    
    String non_logged_file_path = "E:\\Sangeeta\\Research\\L5IMBAL\\result\\hd_non_log_if.txt";
	String logged_file_path = "E:\\Sangeeta\\Research\\L5IMBAL\\result\\hd_log_if.txt";
   ...
   //*/
    ...
    String non_logged_file_path = "D:\\Sangeeta\\Research\\L5IMBAL\\result\\hd_non_log_if.txt";
	String logged_file_path = "D:\\Sangeeta\\Research\\L5IMBAL\\result\\hd_log_if.txt";
   ...
   //*/
	...
	{				    
		Hadoop_Training5_IF demo = new Hadoop_Training5_IF();
...
public void ast_prser(String file_name)
	{
		try
		{
			...
			rawContent = Hadoop_Training5_IF.readFileToString(file_name);
