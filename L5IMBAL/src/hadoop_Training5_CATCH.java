...
public class hadoop_Training5_CATCH
{
	...
	//@Note: create this file using create_file_listing.py
	 ...
	 String non_logged_file_path = "E:\\Sangeeta\\Research\\L5IMBAL\\result\\hd_non_log_catch.txt";
	 String logged_file_path = "E:\\Sangeeta\\Research\\L5IMBAL\\result\\hd_log_catch.txt";
	  String table = "hd_catch_training5";
   //*/
  ...
  //*/
	...
	public static void main(String[] args) 
	{
		...
		hadoop_Training5_CATCH demo = new hadoop_Training5_CATCH();
...
public void ast_prser(String file_name)
	{
		try
		{
			...
			rawContent = hadoop_Training5_CATCH.readFileToString(file_name);
