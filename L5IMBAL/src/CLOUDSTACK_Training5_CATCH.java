...
public class CLOUDSTACK_Training5_CATCH
{
	...
	//@Note: create this file using create_file_listing.py
	 String listing_file_path = "F:\\Research\\L5IMBAL\\result\\cloudstack-4.3.0_java_files.txt";
	 String non_logged_file_path = "F:\\Research\\L5IMBAL\\result\\cloudstack_non_log_catch.txt";
	 String logged_file_path = "F:\\Research\\L5IMBAL\\result\\cloudstack_log_catch.txt";
	 String table = "cloudstack_catch_training5";
	//*/
	...
	//@Note: create this file using create_file_listing.py
	 String listing_file_path = "E:\\Sangeeta\\Research\\L5IMBAL\\result\\cloudstack-4.3.0_java_files.txt";  
	 String non_logged_file_path = "E:\\Sangeeta\\Research\\L5IMBAL\\result\\cloudstack_non_log_catch.txt";
	 String logged_file_path = "E:\\Sangeeta\\Research\\L5IMBAL\\result\\cloudstack_log_catch.txt";
	  String table = "cloudstack_catch_training5";
   //*/
	...
	//@Note: create this file using create_file_listing.py
	 String listing_file_path = "D:\\Sangeeta\\Research\\L5IMBAL\\result\\cloudstack-4.3.0_java_files.txt";  
	 String non_logged_file_path = "D:\\Sangeeta\\Research\\L5IMBAL\\result\\cloudstack_non_log_catch.txt";
	 String logged_file_path = "D:\\Sangeeta\\Research\\L5IMBAL\\result\\cloudstack_log_catch.txt";
	  String table = "cloudstack_catch_training5";
  //*/
	...
	public static void main(String[] args) 
	{
		...
		CLOUDSTACK_Training5_CATCH demo = new CLOUDSTACK_Training5_CATCH();
...
public void ast_prser(String file_name)
	{
		try
		{
			...
			rawContent = CLOUDSTACK_Training5_CATCH.readFileToString(file_name);
