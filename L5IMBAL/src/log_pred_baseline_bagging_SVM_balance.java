 ...
 * 2. Version  =  baseline 
 * */
public class log_pred_baseline_bagging_SVM_balance
{
	...
	String result_table = "result_baseline_bagging_balance_"+type;
...
public static void main(String args[])
	{
	  ...
	  Classifier models [] = {  new RandomForest(),
		...
		log_pred_baseline_bagging_SVM_balance clp = new log_pred_baseline_bagging_SVM_balance();
