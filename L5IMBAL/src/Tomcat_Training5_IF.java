...
public class Tomcat_Training5_IF
{
    ...
    String non_logged_file_path = "E:\\Sangeeta\\Research\\L5IMBAL\\result\\tomcat_non_log_if.txt";
	String logged_file_path = "E:\\Sangeeta\\Research\\L5IMBAL\\result\\tomcat_log_if.txt";
   ...
   //*/
	...
	{				    
		Tomcat_Training5_IF demo = new Tomcat_Training5_IF();
...
public void ast_prser(String file_name)
	{
		try
		{
			...
			rawContent = Tomcat_Training5_IF.readFileToString(file_name);
